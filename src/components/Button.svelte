...
<div class="flex flex-col">
  {#if !solana}
    <button
      class=" px-3 py-2 rounded-md  bg-neutral-800  hover:bg-neutral-900 text-white font-bold"
  ...
  {:else if $userState.userBalance < nftPrice()}
    <button
      class=" px-3 py-2 rounded-md  bg-neutral-800  hover:bg-neutral-900 text-white font-bold disabled:bg-gray-400"
      disabled={true}
  ...
  {:else}
    <button
      class=" px-3 py-2 rounded-md  bg-neutral-800  hover:bg-neutral-800 text-white font-bold disabled:bg-gray-400"
      disabled={isMinting}
      on:click={mint}
    >
      {#if isMinting}
